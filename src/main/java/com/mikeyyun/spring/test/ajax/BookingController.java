...
import com.mikeyyun.spring.test.ajax.domain.Booking;
import com.mikeyyun.spring.test.ajax.service.BookingService;
...
public class BookingController {
	...
	// When : 사용자가 예약 정보를 입력하고 저장을 수행하고자 할 때
	// Where : 서버 
	// input (request) : 예약에 필요한 얘약자 정보
	// 기능 (What) : 예약자 정보를 저장한다.
	// How : 예약 정보를 booking 테이블에 insert 한다.
	// Why : 테이블에 저장해야 나중에 예약 목록을 얻어올 수 있어서
	...
	// 어떻게 : booking 테이블에 이름과 전화번호 조건으로 일치하는 행 select
	// 왜 : 예약자의 모든 정보가 필요하니까
	// output : 예약자 정보
	@ResponseBody
	@GetMapping("/info")
